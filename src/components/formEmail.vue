    ...
    <div>
        <div class="destop">
            <div class="main">
                <div class="CoreFrom">
                    <div class="titleFrom">
                        <p class="title1" data-aos="fade-up" data-aos-duration="1000">Dapatkan best price dari Spektra
                        </p>
                        <p class="title2" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            kebutuhan
                            perusahaan
                            Anda melalui kotak pesan berikut ini.
                        </p>
                            ...
                            <ul class="space-y-4 text-gray-500 list-disc list-inside dark:text-gray-400">
                                <li class="" data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <ol class="ps-5 mt-2 space-y-1 list-inside">
                                        <li>
                                            <p>Kami akan melihat dan menganalisa kebutuhan Anda sebelum masuk ke proses
                                                pembuatan penawaran harga</p>
                                        </li>
                                    </ol>
                                </li>
                                ...
                                <li data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <ul class="ps-5 mt-2 space-y-1 list-inside">
                                        <li>
                                            Untuk menjalin kemitraan yang profesional, kami akan kontrak kerja sesuai
                                            dengan
                                ...
                                <li data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <ul class="ps-5 mt-2 space-y-1 list-inside">
                                        <li>
                                            <p>
                                                Selama pekerjaan berlangsung, akan ada proses monitoring dan evaluasi
                                                yang
                                                dilakukan secara berkala
                                                untuk memastikan kualitas dan ketepatan waktu
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="titleFrom2">
                        <form class="max-w-md mx-auto" action="post" ref="form" method="" @submit.prevent="sendEmail">
                            <h2 class="text-black font-bold text-2xl">Konsultasi Gratis dan Cepat</h2>
